module bchess.org/dist-scheduler
...
require (
	...
	k8s.io/kube-scheduler v0.31.3 // indirect
...
replace (
	...
	k8s.io/component-helpers => ./fork/kubernetes/staging/src/k8s.io/component-helpers
	...
	k8s.io/kubernetes => ./fork/kubernetes
