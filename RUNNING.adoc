...
The code is available on https://github.com/k8s-1m/k8s-1m[GitHub] under an Apache 2.0 license. Questions and comments are welcome in the Discussions section, but do not expect this code to be actively maintained. I likely will _not_ be fixing bugs or adding features.
