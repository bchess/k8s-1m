...
== How to run yourself
See the
ifdef::backend-html5[link:RUNNING.html[RUNNING]]
ifndef::backend-html5[https://github.com/bchess/k8s-1m/blob/main/RUNNING.adoc[RUNNING]]
file for instructions on how to run a cluster yourself.
